...
class GitTest < Test::Unit::TestCase
  ...
  def test_checkout_branch
    ...
    assert_equal current_branch, Toolshed::Git.branch_name
  ...
  def test_checkout_branch_by_id
    ...
    Toolshed::Git.checkout_branch(branch_id)
    assert_equal new_branch_name, Toolshed::Git.branch_name
  ...
  def test_branched_from
    current_branch = Toolshed::Git.branch_name
    current_branch_branched_from = Toolshed::Git.branched_from
  ...
  def test_delete_branch
    ...
    remote_current_branch = Toolshed::Git.branch_name
    Toolshed::Git.checkout_branch(new_branch_name)
    assert_equal new_branch_name, Toolshed::Git.branch_name
    Toolshed::Git.checkout_branch(remote_current_branch)
